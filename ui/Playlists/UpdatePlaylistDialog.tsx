...
export default function UpdatePlaylistDialog({mutate, setClose, playlist}:UpdatePlaylistProps) {
    ...
    <>
     <IconButton edge="end" color="inherit" onClick={handleClickOpen} aria-label="close">
      ...
      >
        ...
        <UpdatePlaylistForm mutate={mutate} playlist={playlist} setClose={setClose}/>
